...
const ServicesSection = () => {
  ...
  const defaultServices = [
    ...
    },
    {
      ...
      description:
        "Comprehensive primary healthcare and preventive medicine services.",
    },
    {
      id: 3,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {services.slice(0, 4).map((service, index) => {
            ...
            return (
              <Card
                key={service.id}
                className="medical-card-hover border-0 shadow-lg bg-white animate-fade-in-up"
        ...
        >
          <Link to="/services">
            <Button
              size="lg"
              className="medical-gradient text-white hover:opacity-90 px-8 py-3 transition-all duration-200 hover:scale-105"
            >
              সেবা সমূহ
            </Button>
          </Link>

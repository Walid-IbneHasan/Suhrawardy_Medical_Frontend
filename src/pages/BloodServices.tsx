  ...
  const handleDonateSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Thank you for your interest in donating blood. We will contact you soon.",
      });
            ...
            {[
              ...
              return (
                <button
                  key={tab.id}
                  onClick={() =>
                    setActiveTab(tab.id as "request" | "donate" | "inventory")
                  }
                  ...
                  {vaccineInventory.map((vaccine) => (
                    ...
                    >
                      ...
                      <CardContent>
                        <Badge
                          variant={
                            vaccine.available ? "default" : "destructive"
                          }
              ...
              {!isAuthenticated ? (
                ...
                <Card className="shadow-xl">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Fill out this form to request blood. We will contact you
                      as soon as possible.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>

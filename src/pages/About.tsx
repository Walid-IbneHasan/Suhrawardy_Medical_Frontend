...
const leadersRows: string[][] = [
  ...
  ["২০২৩-২৪", "প্রসেনজিৎ সাহা", "মোঃ সাদিকুর রহমান ইফাত"],
  ["২০২৪-২৫", "মোঃ শাহ সাইদ মোরশেদ", "মো.জিহাদ হোসেন"],
];
...
const centralRows: string[][] = [
  ...
  ["২০২৩-২৪", "ইফেতেখারুল ইসলাম রাফি", "যুগ্ম সাংগঠিনিক সম্পাদক ১"],
  ["২০২৪-২৫", " মোঃ সাদিকুর রহমান ইফাত ", "সাধারন সম্পাদক"],
];
/* ----------------------------------------------------------------------------- */
